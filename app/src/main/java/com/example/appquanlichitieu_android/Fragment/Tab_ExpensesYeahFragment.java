...
public class Tab_ExpensesYeahFragment extends Fragment {

    private RecyclerView rcvCatalogYeah;
    private PieChart pieChart;
    private ExpensesDAO ex;
    private List_item_ExpensesADapter expensesADapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab__expenses_yeah, container, false);
    ...
    public void Reload(Bundle bundle){
        ...
        setDataRCV(Integer.parseInt(nam));
    }
    private void getIdCatalog(View view){
        ex = new ExpensesDAO(getContext());
        rcvCatalogYeah = view.findViewById(R.id.listChiReport_Year);
        pieChart = view.findViewById(R.id.pieChartExpensesYear);
    }
