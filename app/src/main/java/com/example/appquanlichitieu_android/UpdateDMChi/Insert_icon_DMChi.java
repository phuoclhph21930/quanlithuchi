...
public class Insert_icon_DMChi extends AppCompatActivity {
    private GridView viewInsert;
    private EditText edtInsert;
    private Button btnInsert;
    private ImageView backInsert;
    private CatalogSpendDAO autumnDao;
    private catalogSpendModel categoryAutumnModel;
    private ImageThu_DAO imageThuDao;
    private List<catalogSpendModel> spendModelList;
    private List<imageThu_Model> list;
    private Insert_icon_DMThu_Adapter imageDmThuAdapter;
    private String ImgThu = "";
    private int selectedItemPosition = -1;
    private imageChi_model image;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_insert_icon_dmchi);
        viewInsert = findViewById(R.id.viewInsert_chi);
        edtInsert = findViewById(R.id.edtInsert_chi);
        btnInsert = findViewById(R.id.btnInsert_chi);
        backInsert = findViewById(R.id.back_insert);

        spendModelList = new ArrayList<>();
        autumnDao = new CatalogSpendDAO(this);
        ...
        viewInsert.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                // Đặt màu sắc của item được chọn
        ...
        btnInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                categoryAutumnModel= new catalogSpendModel(ImgThu,tenDanhmuc);
                if (autumnDao.insert(categoryAutumnModel)>0){
                    Toast.makeText(Insert_icon_DMChi.this, "Bạn đã thêm thành công", Toast.LENGTH_SHORT).show();
                }
            }
        });
